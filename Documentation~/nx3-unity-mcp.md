...
- `click_at`, `click_ui_text`
- `enter_play_mode`, `exit_play_mode`
- `dump_ui`, `batch`, `resolve_packages`

Code/compile commands (bridge protocol v2-v4):
...
- `unity_enter_play_mode`, `unity_exit_play_mode`
- `unity_click_ui_text`, `unity_wait_ui_text`, `unity_click_ui_text_and_wait`
